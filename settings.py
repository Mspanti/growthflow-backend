...
ROOT_URLCONF = 'growthflow_backend.urls'
...
WSGI_APPLICATION = 'growthflow_backend.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('POSTGRES_DB', 'growthflow_db'),
        'USER': os.environ.get('POSTGRES_USER', 'postgres'),
        'PASSWORD': os.environ.get('POSTGRES_PASSWORD', 'admin2310'),
